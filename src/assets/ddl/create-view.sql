...
;
DROP VIEW IF EXISTS asset_type_master
;
DROP VIEW IF EXISTS region_master
;
DROP VIEW IF EXISTS company
;
DROP VIEW IF EXISTS company_locations
;
...
SELECT
  ...
  || chr(9) || COALESCE((SELECT array_to_string(array(SELECT DISTINCT composite_asset_id FROM asset_versions WHERE asset_id = gcon.asset_id AND type_id = gcon.type_id),chr(9))), '')
  || chr(9) || COALESCE((SELECT array_to_string(array(SELECT DISTINCT composite_asset_type_id FROM asset_versions WHERE asset_id = gcon.asset_id AND type_id = gcon.type_id),chr(9))), '')
  || chr(9) || COALESCE((SELECT array_to_string(array(SELECT DISTINCT subpart_name FROM asset_versions WHERE asset_id = gcon.asset_id AND type_id = gcon.type_id),chr(9))), '')
  || chr(9) || COALESCE((SELECT array_to_string(array(SELECT DISTINCT subpart_version FROM asset_versions WHERE asset_id = gcon.asset_id AND type_id = gcon.type_id),chr(9))), '')
